package com.hualianzb.biut.views;
...
public class WaitDialog extends Dialog {
    ...
    private DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) BIUTApplication.getInstance().getApplicationContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay()

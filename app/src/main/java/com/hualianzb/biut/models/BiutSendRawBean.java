 ...
 * describe:
 */
public class BiutSendRawBean implements Serializable {
    /**
     * jsonrpc : 2.0
...
//        }
        ...
        public static class DataBean extends SendRawBean.ParamsBean.DataBean implements Serializable {
            public DataBean() {
            }
